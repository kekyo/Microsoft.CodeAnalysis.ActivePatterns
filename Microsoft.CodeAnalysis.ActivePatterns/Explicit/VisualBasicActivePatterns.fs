...
module ActivePatterns =
  ...
  let (|EmptyStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.EmptyStatementSyntax as node ->
      Some (node.Empty)
    | _ -> None

  let (|EndBlockStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.EndBlockStatementSyntax as node ->
      Some (node.EndKeyword, node.BlockKeyword)
    | _ -> None

  let (|CompilationUnitSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|OptionStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ImportsStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ImportsStatementSyntax as node ->
      Some (node.ImportsKeyword)
    | _ -> None

  let (|SimpleImportsClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.SimpleImportsClauseSyntax as node ->
      Some (node.Alias, node.Name)
    | _ -> None

  let (|ImportAliasClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ImportAliasClauseSyntax as node ->
      Some (node.Identifier, node.EqualsToken)
    | _ -> None

  let (|XmlNamespaceImportsClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|NamespaceBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|NamespaceStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.NamespaceStatementSyntax as node ->
      Some (node.NamespaceKeyword, node.Name)
    | _ -> None

  let (|ModuleBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|StructureBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InterfaceBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ClassBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EnumBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InheritsStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.InheritsStatementSyntax as node ->
      Some (node.InheritsKeyword)
    | _ -> None

  let (|ImplementsStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ImplementsStatementSyntax as node ->
      Some (node.ImplementsKeyword)
    | _ -> None

  let (|ModuleStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|StructureStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InterfaceStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ClassStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EnumStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TypeParameterListSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TypeParameterSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TypeParameterSingleConstraintClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TypeParameterMultipleConstraintClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SpecialConstraintSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.SpecialConstraintSyntax as node ->
      Some (node.ConstraintKeyword)
    | _ -> None

  let (|TypeConstraintSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TypeConstraintSyntax as node ->
      Some (node.Type)
    | _ -> None

  let (|EnumMemberDeclarationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|MethodBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ConstructorBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|OperatorBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|AccessorBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|PropertyBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EventBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ParameterListSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ParameterListSyntax as node ->
      Some (node.OpenParenToken, node.CloseParenToken)
    | _ -> None

  let (|MethodStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SubNewStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|DeclareStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|DelegateStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EventStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|OperatorStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|PropertyStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|AccessorStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ImplementsClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ImplementsClauseSyntax as node ->
      Some (node.ImplementsKeyword)
    | _ -> None

  let (|HandlesClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.HandlesClauseSyntax as node ->
      Some (node.HandlesKeyword)
    | _ -> None

  let (|KeywordEventContainerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.KeywordEventContainerSyntax as node ->
      Some (node.Keyword)
    | _ -> None

  let (|WithEventsEventContainerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.WithEventsEventContainerSyntax as node ->
      Some (node.Identifier)
    | _ -> None

  let (|WithEventsPropertyEventContainerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|HandlesClauseItemSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|IncompleteMemberSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|FieldDeclarationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.FieldDeclarationSyntax as node ->
      Some (node.AttributeLists |> Seq.toList)
    | _ -> None

  let (|VariableDeclaratorSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.VariableDeclaratorSyntax as node ->
      Some (node.AsClause, node.Initializer)
    | _ -> None

  let (|SimpleAsClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|AsNewClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AsNewClauseSyntax as node ->
      Some (node.AsKeyword, node.NewExpression)
    | _ -> None

  let (|ObjectMemberInitializerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ObjectCollectionInitializerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InferredFieldInitializerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.InferredFieldInitializerSyntax as node ->
      Some (node.KeyKeyword, node.Expression)
    | _ -> None

  let (|NamedFieldInitializerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EqualsValueSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.EqualsValueSyntax as node ->
      Some (node.EqualsToken, node.Value)
    | _ -> None

  let (|ParameterSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ModifiedIdentifierSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ArrayRankSpecifierSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|AttributeListSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AttributeListSyntax as node ->
      Some (node.LessThanToken, node.GreaterThanToken)
    | _ -> None

  let (|AttributeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AttributeSyntax as node ->
      Some (node.Target, node.Name, node.ArgumentList)
    | _ -> None

  let (|AttributeTargetSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AttributeTargetSyntax as node ->
      Some (node.AttributeModifier, node.ColonToken)
    | _ -> None

  let (|AttributesStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AttributesStatementSyntax as node ->
      Some (node.AttributeLists |> Seq.toList)
    | _ -> None

  let (|ExpressionStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ExpressionStatementSyntax as node ->
      Some (node.Expression)
    | _ -> None

  let (|PrintStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.PrintStatementSyntax as node ->
      Some (node.QuestionToken, node.Expression)
    | _ -> None

  let (|WhileBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|UsingBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SyncLockBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|WithBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SingleLineElseClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|MultiLineIfBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|IfStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.IfStatementSyntax as node ->
      Some (node.IfKeyword, node.Condition, node.ThenKeyword)
    | _ -> None

  let (|ElseIfBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ElseIfBlockSyntax as node ->
      Some (node.ElseIfStatement, node.Statements |> Seq.toList)
    | _ -> None

  let (|ElseIfStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ElseBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ElseBlockSyntax as node ->
      Some (node.ElseStatement, node.Statements |> Seq.toList)
    | _ -> None

  let (|ElseStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ElseStatementSyntax as node ->
      Some (node.ElseKeyword)
    | _ -> None

  let (|TryBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TryStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TryStatementSyntax as node ->
      Some (node.TryKeyword)
    | _ -> None

  let (|CatchBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CatchBlockSyntax as node ->
      Some (node.CatchStatement, node.Statements |> Seq.toList)
    | _ -> None

  let (|CatchStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|CatchFilterClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CatchFilterClauseSyntax as node ->
      Some (node.WhenKeyword, node.Filter)
    | _ -> None

  let (|FinallyBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|FinallyStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.FinallyStatementSyntax as node ->
      Some (node.FinallyKeyword)
    | _ -> None

  let (|ErrorStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ErrorStatementSyntax as node ->
      Some (node.ErrorKeyword, node.ErrorNumber)
    | _ -> None

  let (|OnErrorGoToStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|OnErrorResumeNextStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ResumeStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ResumeStatementSyntax as node ->
      Some (node.ResumeKeyword, node.Label)
    | _ -> None

  let (|SelectBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SelectStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|CaseBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CaseBlockSyntax as node ->
      Some (node.CaseStatement, node.Statements |> Seq.toList)
    | _ -> None

  let (|CaseStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CaseStatementSyntax as node ->
      Some (node.CaseKeyword)
    | _ -> None

  let (|ElseCaseClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ElseCaseClauseSyntax as node ->
      Some (node.ElseKeyword)
    | _ -> None

  let (|SimpleCaseClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.SimpleCaseClauseSyntax as node ->
      Some (node.Value)
    | _ -> None

  let (|RangeCaseClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|RelationalCaseClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SyncLockStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.SyncLockStatementSyntax as node ->
      Some (node.SyncLockKeyword, node.Expression)
    | _ -> None

  let (|DoLoopBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ForEachBlockSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ForStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ForStepClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ForStepClauseSyntax as node ->
      Some (node.StepKeyword, node.StepValue)
    | _ -> None

  let (|ForEachStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|RaiseEventStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|WithStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.WithStatementSyntax as node ->
      Some (node.WithKeyword, node.Expression)
    | _ -> None

  let (|ReDimStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ReDimStatementSyntax as node ->
      Some (node.ReDimKeyword, node.PreserveKeyword)
    | _ -> None

  let (|RedimClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.RedimClauseSyntax as node ->
      Some (node.Expression, node.ArrayBounds)
    | _ -> None

  let (|EraseStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.EraseStatementSyntax as node ->
      Some (node.EraseKeyword)
    | _ -> None

  let (|LiteralExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.LiteralExpressionSyntax as node ->
      Some (node.Token)
    | _ -> None

  let (|ParenthesizedExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TupleExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TupleExpressionSyntax as node ->
      Some (node.OpenParenToken, node.CloseParenToken)
    | _ -> None

  let (|TupleTypeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TupleTypeSyntax as node ->
      Some (node.OpenParenToken, node.CloseParenToken)
    | _ -> None

  let (|TypedTupleElementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TypedTupleElementSyntax as node ->
      Some (node.Type)
    | _ -> None

  let (|NamedTupleElementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.NamedTupleElementSyntax as node ->
      Some (node.Identifier, node.AsClause)
    | _ -> None

  let (|MeExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.MeExpressionSyntax as node ->
      Some (node.Keyword)
    | _ -> None

  let (|MyBaseExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.MyBaseExpressionSyntax as node ->
      Some (node.Keyword)
    | _ -> None

  let (|MyClassExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.MyClassExpressionSyntax as node ->
      Some (node.Keyword)
    | _ -> None

  let (|GetTypeExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TypeOfExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|GetXmlNamespaceExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|MemberAccessExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlMemberAccessExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InvocationExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.InvocationExpressionSyntax as node ->
      Some (node.Expression, node.ArgumentList)
    | _ -> None

  let (|ObjectCreationExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|AnonymousObjectCreationExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ArrayCreationExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|CollectionInitializerSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|CTypeExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|DirectCastExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.DirectCastExpressionSyntax as node ->
      Some (node.Keyword, node.OpenParenToken, node.Expression, node.CommaToken, node.Type, node.CloseParenToken)
    | _ -> None

  let (|TryCastExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TryCastExpressionSyntax as node ->
      Some (node.Keyword, node.OpenParenToken, node.Expression, node.CommaToken, node.Type, node.CloseParenToken)
    | _ -> None

  let (|PredefinedCastExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|BinaryExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.BinaryExpressionSyntax as node ->
      Some (node.Left, node.OperatorToken, node.Right)
    | _ -> None

  let (|UnaryExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.UnaryExpressionSyntax as node ->
      Some (node.OperatorToken, node.Operand)
    | _ -> None

  let (|BinaryConditionalExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|TernaryConditionalExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|SingleLineLambdaExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|MultiLineLambdaExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|LambdaHeaderSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ArgumentListSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ArgumentListSyntax as node ->
      Some (node.OpenParenToken, node.CloseParenToken)
    | _ -> None

  let (|OmittedArgumentSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.OmittedArgumentSyntax as node ->
      Some (node.Empty, node.IsNamed)
    | _ -> None

  let (|SimpleArgumentSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|NameColonEqualsSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.NameColonEqualsSyntax as node ->
      Some (node.Name, node.ColonEqualsToken)
    | _ -> None

  let (|RangeArgumentSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|QueryExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.QueryExpressionSyntax as node ->
      Some (node.Clauses |> Seq.toList)
    | _ -> None

  let (|CollectionRangeVariableSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ExpressionRangeVariableSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ExpressionRangeVariableSyntax as node ->
      Some (node.NameEquals, node.Expression)
    | _ -> None

  let (|AggregationRangeVariableSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AggregationRangeVariableSyntax as node ->
      Some (node.NameEquals, node.Aggregation)
    | _ -> None

  let (|VariableNameEqualsSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|FunctionAggregationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|GroupAggregationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.GroupAggregationSyntax as node ->
      Some (node.GroupKeyword)
    | _ -> None

  let (|FromClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.FromClauseSyntax as node ->
      Some (node.FromKeyword)
    | _ -> None

  let (|LetClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.LetClauseSyntax as node ->
      Some (node.LetKeyword)
    | _ -> None

  let (|AggregateClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|DistinctClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.DistinctClauseSyntax as node ->
      Some (node.DistinctKeyword)
    | _ -> None

  let (|WhereClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.WhereClauseSyntax as node ->
      Some (node.WhereKeyword, node.Condition)
    | _ -> None

  let (|PartitionWhileClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|PartitionClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.PartitionClauseSyntax as node ->
      Some (node.SkipOrTakeKeyword, node.Count)
    | _ -> None

  let (|GroupByClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|JoinConditionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.JoinConditionSyntax as node ->
      Some (node.Left, node.EqualsKeyword, node.Right)
    | _ -> None

  let (|SimpleJoinClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|GroupJoinClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|OrderByClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.OrderByClauseSyntax as node ->
      Some (node.OrderKeyword, node.ByKeyword)
    | _ -> None

  let (|OrderingSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.OrderingSyntax as node ->
      Some (node.Expression, node.AscendingOrDescendingKeyword)
    | _ -> None

  let (|SelectClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.SelectClauseSyntax as node ->
      Some (node.SelectKeyword)
    | _ -> None

  let (|XmlDocumentSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlDeclarationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlDeclarationOptionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlDeclarationOptionSyntax as node ->
      Some (node.Name, node.Equals, node.Value)
    | _ -> None

  let (|XmlElementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlElementSyntax as node ->
      Some (node.StartTag, node.Content |> Seq.toList, node.EndTag)
    | _ -> None

  let (|XmlElementStartTagSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlElementEndTagSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlEmptyElementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlAttributeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlAttributeSyntax as node ->
      Some (node.Name, node.EqualsToken, node.Value)
    | _ -> None

  let (|XmlStringSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlStringSyntax as node ->
      Some (node.StartQuoteToken, node.EndQuoteToken)
    | _ -> None

  let (|XmlPrefixNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlPrefixNameSyntax as node ->
      Some (node.Name)
    | _ -> None

  let (|XmlNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlNameSyntax as node ->
      Some (node.Prefix, node.LocalName)
    | _ -> None

  let (|XmlBracketedNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlPrefixSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlPrefixSyntax as node ->
      Some (node.Name, node.ColonToken)
    | _ -> None

  let (|XmlCommentSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlProcessingInstructionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlCDataSectionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlCDataSectionSyntax as node ->
      Some (node.BeginCDataToken, node.EndCDataToken)
    | _ -> None

  let (|XmlEmbeddedExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ArrayTypeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ArrayTypeSyntax as node ->
      Some (node.ElementType, node.RankSpecifiers |> Seq.toList)
    | _ -> None

  let (|NullableTypeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.NullableTypeSyntax as node ->
      Some (node.ElementType, node.QuestionMarkToken)
    | _ -> None

  let (|PredefinedTypeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.PredefinedTypeSyntax as node ->
      Some (node.Keyword)
    | _ -> None

  let (|IdentifierNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.IdentifierNameSyntax as node ->
      Some (node.Identifier)
    | _ -> None

  let (|GenericNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.GenericNameSyntax as node ->
      Some (node.Identifier, node.TypeArgumentList)
    | _ -> None

  let (|QualifiedNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.QualifiedNameSyntax as node ->
      Some (node.Left, node.DotToken, node.Right)
    | _ -> None

  let (|GlobalNameSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.GlobalNameSyntax as node ->
      Some (node.GlobalKeyword)
    | _ -> None

  let (|TypeArgumentListSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.TypeArgumentListSyntax as node ->
      Some (node.OpenParenToken, node.OfKeyword, node.CloseParenToken)
    | _ -> None

  let (|CrefReferenceSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CrefReferenceSyntax as node ->
      Some (node.Name, node.Signature, node.AsClause)
    | _ -> None

  let (|CrefSignatureSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CrefSignatureSyntax as node ->
      Some (node.OpenParenToken, node.CloseParenToken)
    | _ -> None

  let (|CrefSignaturePartSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.CrefSignaturePartSyntax as node ->
      Some (node.Modifier, node.Type)
    | _ -> None

  let (|CrefOperatorReferenceSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|QualifiedCrefOperatorReferenceSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.QualifiedCrefOperatorReferenceSyntax as node ->
      Some (node.Left, node.DotToken, node.Right)
    | _ -> None

  let (|YieldStatementSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.YieldStatementSyntax as node ->
      Some (node.YieldKeyword, node.Expression)
    | _ -> None

  let (|AwaitExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.AwaitExpressionSyntax as node ->
      Some (node.AwaitKeyword, node.Expression)
    | _ -> None

  let (|DocumentationCommentTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.DocumentationCommentTriviaSyntax as node ->
      Some (node.Content |> Seq.toList)
    | _ -> None

  let (|XmlCrefAttributeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|XmlNameAttributeSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.XmlNameAttributeSyntax as node ->
      Some (node.Name, node.EqualsToken, node.StartQuoteToken, node.Reference, node.EndQuoteToken)
    | _ -> None

  let (|ConditionalAccessExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|NameOfExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InterpolatedStringExpressionSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InterpolatedStringTextSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.InterpolatedStringTextSyntax as node ->
      Some (node.TextToken)
    | _ -> None

  let (|InterpolationSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|InterpolationAlignmentClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.InterpolationAlignmentClauseSyntax as node ->
      Some (node.CommaToken, node.Value)
    | _ -> None

  let (|InterpolationFormatClauseSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ConstDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|IfDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ElseDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
    | :? Microsoft.CodeAnalysis.VisualBasic.Syntax.ElseDirectiveTriviaSyntax as node ->
      Some (node.HashToken, node.ElseKeyword)
    | _ -> None

  let (|EndIfDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|RegionDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EndRegionDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ExternalSourceDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EndExternalSourceDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ExternalChecksumDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|EnableWarningDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|DisableWarningDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|ReferenceDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
  ...
  let (|BadDirectiveTriviaSyntax|_|) (node:Microsoft.CodeAnalysis.VisualBasic.VisualBasicSyntaxNode) =
    match node with
